...
export function createWebApp(deps) {
  const { llmService, statusService, rulesRepository, urlFetcher, webSearch, homeAssistant, notificationService, prometheusClient, downloadClassifier, watchtowerWebhookToken, aptHealthWebhookToken, downloadReportStore, logger, host, port } = deps;
  ...
  registerWebRoutes({ registry, llmService, statusService, rulesRepository, urlFetcher, webSearch, homeAssistant, notificationService, prometheusClient, downloadClassifier, watchtowerWebhookToken, aptHealthWebhookToken, downloadReportStore, logger });
